            ...
            <div className="top-info-card rounded-[28px] bg-white p-5 shadow-lg">
              ...
              <div className="flex items-start gap-4">
                ...
                <div
                  ...
                  <LucideIcon name="lock" className="h-7 w-7" />
              ...
              <div className="policy-card rounded-[28px] bg-white p-6 shadow-lg">
                ...
                <div className="mb-5 flex items-center gap-4">
                  ...
                  <div
                    ...
                    <LucideIcon name="monitor" className="h-7 w-7" />
            ...
            <div className="rounded-[28px] bg-white p-6 shadow-lg">
              ...
              <div className="mb-6 flex items-center gap-4">
                ...
                <div
                  ...
                  <LucideIcon name="database" className="h-7 w-7" />
              ...
              <div className="policy-card rounded-[28px] bg-white p-6 shadow-lg">
                ...
                <div className="mb-5 flex items-center gap-4">
                  ...
                  <div
                    ...
                    <LucideIcon name="globe" className="h-7 w-7" />
            ...
            <div className="rounded-[28px] bg-white p-6 shadow-lg">
              ...
              <div className="mb-5 flex items-center gap-4">
                ...
                <div
                  ...
                  <LucideIcon name="baby" className="h-7 w-7" />
